...
import {
  ...
  addDeleteProjListener,
  addEditTaskListener,
  addEditProjListener,
  addListener,
  addEditChecklistListener,
  addNewBtnListener,
...
export function Display() {
  ...
  const renderProjectCard = (projectData = null) => {
    ...
    const projectIdentifier = projectData
      ? projectData.uuid
  ...
  const renderTaskCard = (taskData = null, parentProject = null) => {
    ...
    const isDummyCard =
      taskData && taskData.title === "Create your first task!";
    ...
    if (!resolvedTaskData) {
      ...
      resolvedTaskData = resolvedTaskData = new Task({
        title: "",
        description: "",
        dueDate: "",
        priority: "low",
    ...
    const matchedPriority = priorityColourMap.find(
      (item) => item.priority === resolvedTaskData.priority,
    );
